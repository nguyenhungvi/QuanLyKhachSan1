                  ...
                  <ul class="nav navbar-nav">
                              ...
                              <ul class="menu">
                                 <li >
                                    ...
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="public/dist/img/basketball-jersey.png" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>polo shirt</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="public/dist/img/shirt.png" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Kits</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="public/dist/img/football.png" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Football</h4>
                                 ...
                                 <li class="nav-list">
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="public/dist/img/shoe.png" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Sports sheos</h4>
                           ...
                           <li>
                              <ul class="menu">
                                 <li>
                                    ...
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="public/dist/img/avatar.png" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Ronaldo</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="public/dist/img/avatar4.png" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Salman</h4>
                     ...
                     <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu" >
                           ...
                           <li><a href="?mod=login&action=logout">
