...
function get_info_cart(){
    ...
    $result= db_fetch_array("SELECT `id_roomtype`,roomtype.name,`number_room` , roomtype.price,(roomtype.price*`number_room`) as total_sum FROM `cart`, `roomtype` WHERE cart.id_roomtype=roomtype.id");
    return $result;
}
