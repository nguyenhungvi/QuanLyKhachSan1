...
function get_info_cart() {
    ...
    $result = db_fetch_array("SELECT `id_roomtype`,roomtype.name, `number_room` , cart.check_in,cart.check_out,number_adults, number_childrens FROM `cart`, `roomtype` WHERE cart.id_roomtype=roomtype.id");
    return $result;
}
