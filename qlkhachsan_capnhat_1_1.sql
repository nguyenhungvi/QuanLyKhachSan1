...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 01, 2021 lúc 04:28 PM
...
INSERT INTO `detailbook` (`id`, `booking_code`, `room_code`, `room_type_id`, `price`, `number_room`, `number_adults`, `number_childrens`, `check_in`, `check_out`, `date_set`) VALUES
(3, 3, 0, 1, 2500, 1, 2, 2, '2020-12-30', '2020-12-31', '2020-12-31'),
(4, 3, 0, 2, 4000, 3, 0, 0, '2020-12-31', '2020-12-31', '2020-12-31'),
(5, 4, 0, 1, 2500, 2, 2, 2, '2020-11-01', '2020-11-04', '2020-12-31'),
(6, 5, 0, 4, 800, 3, 1, 0, '2020-10-29', '2020-10-30', '2020-12-31'),
(7, 6, 0, 6, 1200, 1, 1, 0, '2020-09-16', '2020-09-22', '2020-12-31'),
(8, 7, 0, 1, 2500, 1, 0, 0, '2020-12-31', '2020-12-31', '2020-12-31');
...
ALTER TABLE `detailbook`
  ...
  ADD CONSTRAINT `detailbook_ibfk_2` FOREIGN KEY (`room_code`) REFERENCES `room` (`id`),
  ADD CONSTRAINT `detailbook_ibfk_3` FOREIGN KEY (`room_type_id`) REFERENCES `roomtype` (`id`);

--
-- Các ràng buộc cho bảng `detailbook_room`
--
ALTER TABLE `detailbook_room`
  ADD CONSTRAINT `detailbook_room_ibfk_1` FOREIGN KEY (`room_type_id`) REFERENCES `roomtype` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detailbook_room_ibfk_2` FOREIGN KEY (`booking_code`) REFERENCES `bookroom` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detailbook_room_ibfk_3` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `detail_surcharge`
--
ALTER TABLE `detail_surcharge`
  ADD CONSTRAINT `detail_surcharge_ibfk_1` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detail_surcharge_ibfk_2` FOREIGN KEY (`booking_code`) REFERENCES `bookroom` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
